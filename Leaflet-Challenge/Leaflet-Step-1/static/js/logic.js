...
function createMap(earthquakes, plates) {
    ...
    var streetmap = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/streets-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoicmFmYWVsY2VzcGVkZXMiLCJhIjoiY2tncmI1YTM3MDF3bzJzb210aTljbnJuYSJ9.85FF4YQtdqYkvXri5-kMaA");

    var darkmap = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/dark-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoicmFmYWVsY2VzcGVkZXMiLCJhIjoiY2tncmI1YTM3MDF3bzJzb210aTljbnJuYSJ9.85FF4YQtdqYkvXri5-kMaA");

    var satellitemap = L.tileLayer("https://api.mapbox.com/styles/v1/mapbox/satellite-streets-v9/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoicmFmYWVsY2VzcGVkZXMiLCJhIjoiY2tncmI1YTM3MDF3bzJzb210aTljbnJuYSJ9.85FF4YQtdqYkvXri5-kMaA");
    ...
    // Create a map, giving it the darkmap, earthquakes, and plates layers to display on load
    var myMap = L.map("map", {
        center: [39.502235, -98.343683],
        zoom: 4.5,
